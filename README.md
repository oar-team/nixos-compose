...
The goal of NixOS-Compose is to reduce the burden of setting up _ephemeral_
distributed systems thanks to [Nix](https://nixos.org) functional package
manager and [Nixos](https://nixos.org)
...
The NixOS-Compose project takes inspiration and code from
...
[here](https://nixos-compose.gitlabpages.inria.fr/nixos-compose)
...
- [Painless Transposition of Reproducible Distributed Environments with NixOS Compose](https://www.archives-ouvertes.fr/hal-03723771),
  IEEE Cluster'22 conference, 2022,
  [[pdf](https://hal.archives-ouvertes.fr/hal-03723771v1/document)][[bibtex](https://www.archives-ouvertes.fr/hal-03723771v1/bibtex)].
